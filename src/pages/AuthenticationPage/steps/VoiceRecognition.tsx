...
export const VoiceRecognition: FC = () => {
  ...
  return (
    <StepperFormBox
      ...
      description="For security purposes, please record yourself speaking the passphrase:"
    >
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="relative w-32 h-32 flex items-center justify-center">
            ...
            >
              <Icon icon="mdi:microphone" className="text-white" width="40" height="40" />
            </div>
          </div>
          ...
          <div className="text-center space-y-2">
            ...
            {!isRecording && (
              <p className="text-sm text-gray-500">Hold down the button while speaking</p>
            )}
          </div>
